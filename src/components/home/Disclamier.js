    ...
    return (
        ...
        >
            <div className='bg-[#14375eda] container py-16'>
                ...
                <div className='flex justify-center space-x-5 underline items-center text-white font-bold text-xl pt-16'>

                    <Link href=""> E-Consent </Link>
                    <Link href=""> Privacy Policy </Link>
                    <Link href=""> Terms of Use </Link>
                    <Link href=""> Disclamier Policy </Link>
                    <Link href=""> APR Rates </Link>
